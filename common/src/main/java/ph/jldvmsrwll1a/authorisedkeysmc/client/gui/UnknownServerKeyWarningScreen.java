...
public class UnknownServerKeyWarningScreen extends BaseScreen {
    ...
    public UnknownServerKeyWarningScreen(ClientLoginHandler loginHandler, Component prompt) {
    ...
    public static UnknownServerKeyWarningScreen create(ClientLoginHandler loginHandler, Ed25519PublicKeyParameters serverKey) {
        ...
        return new UnknownServerKeyWarningScreen(loginHandler, prompt);
    }
